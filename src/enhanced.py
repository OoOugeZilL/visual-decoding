...
all_recons = torch.load(f"evals/{args.model_name}/{args.model_name}_all_recons.pt", weights_only=False) # these are the unrefined MindEye2 recons!
all_clipvoxels = torch.load(f"evals/{args.model_name}/{args.model_name}_all_clipvoxels.pt", weights_only=False)
all_blurryrecons = torch.load(f"evals/{args.model_name}/{args.model_name}_all_blurryrecons.pt", weights_only=False)
all_predcaptions = torch.load(f"evals/{args.model_name}/{args.model_name}_all_predcaptions.pt", weights_only=False)
...
base_ckpt_path = '/data20TB/lzg/MindEyeV2/zavychromaxl_v30.safetensors'
...
torch.save(all_enhancedrecons,f"evals/{args.model_name}/{args.model_name}_all_enhancedrecons.pt")
print(f"saved evals/{args.model_name}/{args.model_name}_all_enhancedrecons.pt")
